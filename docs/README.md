...
**All four contracts are deployed on Soroban testnet. 406 tests passing.** See `contracts/deployments/testnet.md` for verified calls and known gaps before further testing.
