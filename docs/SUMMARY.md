...
* [How Writz Works](introduction/how-writz-works.md)
* [Why Stellar, Why Now](introduction/why-stellar-why-now.md)
...
* [The Bitcoin Side](how-it-works/bitcoin-side.md)
* [SPV Verification](how-it-works/spv-verification.md)
* [The ZK Privacy Layer](how-it-works/zk-privacy-layer.md)
* [The Stellar Side](how-it-works/stellar-side.md)
...
* [Blend & USDC Integration](research/blend-usdc-integration.md)
...
* [Application](scf/application.md)
* [Milestone Plan](scf/milestone-plan.md)
* [STRIDE Threat Model](scf/stride-threat-model.md)
