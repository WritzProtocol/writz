...
### Deliverable 1: SPV contract verifies a real Bitcoin mainnet transaction on Stellar testnet
...
The headers and Merkle proof are fetched from a real confirmed Bitcoin mainnet transaction and submitted to the Stellar testnet contract. The contract returns `{ txid, block_hash, confirmations: 6 }`.
...
### Deliverable 1: PrivateLend v1 on Stellar testnet
...
10–15 minute demo of the full deposit → borrow → repay cycle using real Signet BTC and Stellar testnet USDC.
