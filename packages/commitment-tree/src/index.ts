...
export interface Client {
   ...
   */
  repay: ({repayer, zk_proof, public_signals}: {repayer: string, zk_proof: Proof, public_signals: Array<Buffer>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   * |-------|---
   */
  borrow: ({borrower, zk_proof, public_signals}: {borrower: string, zk_proof: Proof, public_signals: Array<Buffer>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   * | 0 | `co
   */
  deposit: ({depositor, headers, merkle_proof_btc, tx_index, raw_tx, zk_proof, public_signals}: {depositor: string, headers: Array<Buffer>, merkle_proof_btc: Array<Buffer>, tx_index: u32, raw_tx: Buffer, zk_proof: Proof, public_signals: Array<Buffer>}, options?: MethodOptions) => Promise<AssembledTransaction<Result<Buffer>>>
